import { RefreshCcw, Clock, AlertCircle, FileText, CheckCircle2, XCircle, Search, Filter, MessageSquare } from 'lucide-react';
            ...
            <div className={`flex-1 p-3 border-x border-b rounded-b-xl ${column.color} flex flex-col gap-3 overflow-y-auto`}>
              ...
              {column.id === 'cooling' && (
                <div className="bg-white p-4 rounded-xl shadow-sm border border-blue-200 cursor-pointer hover:border-blue-400 transition-colors">
                  ...
                  <p className="text-xs text-gray-500 mt-1 line-clamp-2">"Déjame consultarlo con mi esposo"</p>
              ...
              {column.id === 'contact_1' && (
                <div className="bg-white p-4 rounded-xl shadow-sm border border-red-200 cursor-pointer hover:border-red-400 transition-colors relative overflow-hidden">
                  ...
                  <p className="text-xs text-gray-500 mt-1 line-clamp-2">"Me interesa el de color negro, pero..."</p>
